          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground text-balance">
                Premium academic services designed for Saudi Arabian students. Get expert essays, research papers, tutoring, and exam preparation with our 24-hour delivery guarantee.
              </p>
            </div>
